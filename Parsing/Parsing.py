        ...
        for parsing in range(0,runthecode):                                                     # For loop for reduced and raw parsing.
            ...
            for constellation in constellationstoparse:                                         #
                ...
                for satellite in PRNs:                                                          #
                    ...
                    fullname2=reducedorraw+" "+constellation+str(satellite)+" "+readdirectory+" "+CSVfullname
                    ...
                    for selection in range(rangenumber):                                        #
                        ...
                        if os.path.exists(x):                                                   #
                            ...
                            if savelength!=forcomparison:                                       # Discard the .csv files that are empty. Just run the rest of the program if the files have data.
                                ...
                                weeknumber=times[weeknumbercell]                                # that prints the GPS number of the week. Read the string, cut it, and convert
                                ...
                                csvcolumn=(i for i,item in enumerate(weeklistint) if item==weeknumber) # rows in the GPScalendar file correspond to the week number. Then,
                                ...
                                selection=(i for i,item in enumerate(timesflt) if item>=start and item<end)# code and will identify the corresponding lines in the csv file for
                                for i in selection:                                             # each date. The first part corresponds to the first day of the data, and
                                    day1.append(i)                                              # the second part consists of a while loop that will repeat until all the
                                lenday1=len(day1)                                               # rows in the csv file are read.
                                timesflt=timesflt[lenday1:lentimes]                             # The code will print the corresponding row numbers and dates after reading the
                                if lenday1==0:                                                  # file.
                                    beginning1=0                                                #
                                    end1=0                                                      #
                                    ...
                                    stringtoprint="Day 1 goes from cell "+str(beginning1)+" to cell "+str(end1)+". ("+firstday+", "+monthname+" "+str(daynumber)+", "+str(yearnumber)+")"
                                    totallength=end1                                            #
                                import csv                                                      # For day 1: Save all the rows that are part of day 1 in a new matrix that will be printed out later in a new csv file.
                                with open(x) as csvfile:                                        #
                                        readCSV=csv.reader(csvfile, delimiter=',')              #
                                        day1toprint=[]                                          #
                                        rowcount=1                                              #
                                ...
                                pathtoprint=CSVfilesdirectory+filesep+str(yearnumber)+str(monthnumber)+str(daynumber)
                                import os                                                       # Create the folder directory if it does not exist.
                                if not os.path.exists(pathtoprint):                             #
                                    os.makedirs(pathtoprint)                                    #
                                csvfilename1=pathtoprint+filesep+y+"_"+constellation+str(satellite)+"_"+str(yearnumber)+str(monthnumber)+str(daynumber)+".csv"
                                ...
                                while totallength < savelength:
                                    ...
                                    if lenday2==0:                                              #
                                        ...
                                        if monthnumber==1:                                      # Change the month name.
                                            ...
                                            monthname="December"                                #
                                        stringtoprint="Day "+str(daycount)+" goes from cell "+str(beginning2)+" to cell "+str(end2)+". ("+firstday+", "+monthname+" "+str(daynumber)+", "+str(yearnumber)+")"
                                        import csv                                              # For day 2 and on: Save the rows that are to be printed in the variable writecsv files.
                                        with open(x) as csvfile:                                #
                                                readCSV=csv.reader(csvfile, delimiter=',')      #
                                                header=[]                                       #
                                                rowcount=1                                      #
                                        ...
                                        if not os.path.exists(pathtoprint):                     #
                                            os.makedirs(pathtoprint)                            #
                                        csvfilename=pathtoprint+filesep+y+"_"+constellation+str(satellite)+"_"+str(yearnumber)+str(monthnumber)+str(daynumber)+".csv"
                                        import csv                                              #
            ...
            if forlateruse==1:                                                                  #
                done='The following data was parsed: '+filetorun+'. Date: '+str(monthnumber)+' '+str(daynumber)+', '+str(yearnumber)+'. '+constellationandprns
